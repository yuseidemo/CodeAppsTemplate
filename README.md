...
https://github.com/yuseidemo/CodeAppsTemplate
```
...
│   ├── app-config.ts                        #   画面タイトル・ナビ・ルーティング設定（テンプレート）
│   ├── components/                          #   UI コンポーネント + shadcn/ui（共通テンプレート）
│   ├── pages/                               #   レイアウト/共通ページ（テンプレート）
│   ├── providers/                           #   React Context Providers（共通テンプレート）
│   ├── hooks/                               #   共通フック（テンプレート）
│   ├── template-core/
│   │   ├── module.ts                        #   template-core のルート/ナビ定義
│   │   └── pages/
│   │       └── dashboard.tsx                #   軽量コンポーネントベースダッシュボード
...
- 問題報告: [GitHub Issues](https://github.com/yuseidemo/CodeAppsTemplate/issues)
